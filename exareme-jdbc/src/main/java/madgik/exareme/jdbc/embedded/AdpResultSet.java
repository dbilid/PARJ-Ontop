...
public class AdpResultSet implements ResultSet {
	...
	public String getString(int columnIndex) throws SQLException {
		...
		if (type == java.sql.Types.VARCHAR || type == java.sql.Types.LONGVARCHAR || type == java.sql.Types.CHAR) {
			...
			// throw new SQLException("Column " + columnIndex + " is not a
			// String");
		}
	}
	...
	public boolean getBoolean(int columnIndex) throws SQLException {
		...
		if (rsMetadata.getColumnType(columnIndex) == java.sql.Types.BIT) {
			...
			return false;
		} else if (currentRow.get(columnIndex - 1).toString().startsWith("1")
				|| currentRow.get(columnIndex - 1).toString().toLowerCase().equals("true")
				|| currentRow.get(columnIndex - 1).toString().toLowerCase().equals("yes")) {
			return true;
		} else if (currentRow.get(columnIndex - 1).toString().startsWith("0")
				|| currentRow.get(columnIndex - 1).toString().toLowerCase().equals("false")
				|| currentRow.get(columnIndex - 1).toString().toLowerCase().equals("no")) {
			return false;
		} else {
	...
	public int getInt(int columnIndex) throws SQLException {
		...
		try {
			...
			return Math.round(Float.parseFloat(currentRow.get(columnIndex - 1).toString()));
		}
		// } else {
